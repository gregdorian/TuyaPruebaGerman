    ...
    public static class ServiceExtensions
    {
        ...
        public static void AddSwaggerExtension(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Clean Architecture - TuyaPruebaGerman",
                    Description = "Esta Api es una prueba tecnica Para Tuya German Lopez.",
                    Contact = new OpenApiContact
                    {
                        Name = "german lopez r.",
                        Email = "gelord@yahoo.com",
                        Url = new Uri("https://github.com/gregdorian"),
                    }
                });
